...
class GlobalDNS(Construct):
    ...
    def __init__(self, scope: Construct, construct_id: str,
        ...
        # Hosted Zone
        self.hosted_zone = route53.HostedZone(self, "HostedZone",
        ...
        self.dr_health_check = route53.CfnHealthCheck(self, "DRHealthCheck",
            type="HTTPS", 
            resource_path="/health",
    ...
    def _create_health_check_alarms(self, notification_topic: sns.Topic):
        ...
        primary_alarm = cloudwatch.Alarm(self, "PrimaryHealthAlarm",
