...
class SecurityStack(Construct):
    ...
    def __init__(self, scope: Construct, construct_id: str,
        ...
        # WAF Web ACL
        self.web_acl = waf.CfnWebACL(self, "WebACL",
            scope="REGIONAL",
        ...
        # GuardDuty Detector
        self.guardduty_detector = guardduty.CfnDetector(self, "GuardDutyDetector",
            enable=True,
    ...
    def _setup_config_rules(self):
        ...
        config_recorder = config.CfnConfigurationRecorder(self, "ConfigRecorder",
        ...
        config.CfnConfigRule(self, "RootMFAEnabledRule",
        ...
        config.CfnConfigRule(self, "RDSEncryptedRule",
            source=config.CfnConfigRule.SourceProperty(
                owner="AWS", 
