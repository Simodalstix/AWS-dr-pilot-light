...
class EcommerceCompute(Construct):
    ...
    def __init__(self, scope: Construct, construct_id: str,
        ...
        self.instance_profile = iam.InstanceProfile(self, "InstanceProfile",
        ...
        # Listener
        self.listener = self.load_balancer.add_listener("Listener",
            port=80,
            protocol=elbv2.ApplicationProtocol.HTTP,
    ...
    def _create_scaling_policies(self, notification_topic: sns.Topic):
        ...
        # Scale Up Policy
        scale_up_policy = self.auto_scaling_group.scale_on_metric("ScaleUpPolicy",
        ...
        # Scale Down Policy
        scale_down_policy = self.auto_scaling_group.scale_on_metric("ScaleDownPolicy",
            metric=cloudwatch.Metric(
                namespace="AWS/ApplicationELB",
                metric_name="TargetResponseTime",
                dimensions_map={
            ...
            scaling_steps=[
                autoscaling.ScalingInterval(upper=0.5, change=-1)
            ],
            adjustment_type=autoscaling.AdjustmentType.CHANGE_IN_CAPACITY,
    ...
    def _create_compute_alarms(self, notification_topic: sns.Topic):
        ...
        # ALB Target Health
        cloudwatch.Alarm(self, "UnhealthyTargetsAlarm",
        ...
        # ALB Response Time
        cloudwatch.Alarm(self, "HighResponseTimeAlarm",
        ...
        # ALB 5XX Errors
        cloudwatch.Alarm(self, "HighErrorRateAlarm",
