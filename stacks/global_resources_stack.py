from aws_cdk import Stack, aws_sns as sns, Tags
...
class GlobalResourcesStack(Stack):
    def __init__(
        ...
        **kwargs,
        ...
        self.global_notification_topic = sns.Topic(
            self, "GlobalNotificationTopic", display_name="Global DR Notifications"
        )

        # Global DNS with Route 53 failover
        self.global_dns = GlobalDNS(
            self,
            "GlobalDNS",
